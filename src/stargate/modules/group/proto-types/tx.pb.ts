...
import { DeepPartial, Exact, Rpc, isSet } from "../helpers";
import { Any } from "./any";
import { BinaryReader, BinaryWriter } from "./binary";
import { MemberRequest, ProposalExecutorResult, VoteOption, proposalExecutorResultFromJSON, proposalExecutorResultToJSON, voteOptionFromJSON, voteOptionToJSON } from "./types.pb";
  ...
  export const MsgCreateGroupResponse = {
    ...
    fromJSON(object: any): MsgCreateGroupResponse {
      ...
      if (isSet(object.groupId)) obj.groupId = Number(object.groupId.toString());
      return obj;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<MsgCreateGroupResponse>, I>>(object: I): MsgCreateGroupResponse {
      ...
      if (object.groupId !== undefined && object.groupId !== null) {
        message.groupId = Number(object.groupId.toString());
      }
      return message;
    },
  };
  ...
  export const MsgCreateGroupWithPolicyResponse = {
    ...
    toJSON(message: MsgCreateGroupWithPolicyResponse): unknown {
      const obj: any = {};
      message.groupId !== undefined && (obj.groupId = Number(message.groupId.toString() || 0));
      message.groupPolicyAddress !== undefined && (obj.groupPolicyAddress = message.groupPolicyAddress);
      return obj;
    },
  ...
  export const MsgSubmitProposalResponse = {
    ...
    encode(message: MsgSubmitProposalResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
      if (message.proposalId !== Number(0)) {
    ...
    fromJSON(object: any): MsgSubmitProposalResponse {
      ...
      if (isSet(object.proposalId)) obj.proposalId = Number(object.proposalId.toString());
      return obj;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<MsgSubmitProposalResponse>, I>>(
      ...
      if (object.proposalId !== undefined && object.proposalId !== null) {
        message.proposalId = Number(object.proposalId.toString());
      }
      return message;
    },
  };
