  ...
  return {
    group: {
      groupInfo: async (groupId: number) => {
        return queryService.GroupInfo({ groupId: groupId });
      },
      ...
      groupMembers: async (groupId: number, paginationKey?: PageRequest | undefined) => {
        return queryService.GroupMembers({ groupId: groupId, pagination: paginationKey });
      },
      ...
      groupPoliciesByGroup: async (groupId: number, paginationKey?: PageRequest | undefined) => {
        return queryService.GroupPoliciesByGroup({ groupId: groupId, pagination: paginationKey });
      },
      ...
      proposal: async (proposalId: number) => {
        return queryService.Proposal({ proposalId: BigInt(proposalId) });
      },
      ...
      voteByProposalVoter: async (proposalId: number, voter: string) => {
        return queryService.VoteByProposalVoter({ proposalId: BigInt(proposalId), voter: voter });
      },
      votesByProposal: async (proposalId: number, paginationKey?: PageRequest | undefined) => {
        return queryService.VotesByProposal({ proposalId: BigInt(proposalId), pagination: paginationKey });
      },
      ...
      tallyResult: async (proposalId: number) => {
        return queryService.TallyResult({ proposalId: BigInt(proposalId) });
      }
    },
  };
}
